...
class TakeBottomRightCheckerRule
{
public:

	TakeBottomRightCheckerRule() = default;

	bool validate(Coordinate& coordinate1, Coordinate& coordinate2, const ChekerTable& table, unsigned short oppositeCheckerColor) {
